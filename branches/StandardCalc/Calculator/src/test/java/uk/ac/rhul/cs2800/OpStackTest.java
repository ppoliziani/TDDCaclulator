...
class OpStackTest {
  ...
  @Test
  // 4th test
  // To pass this test I added a check iif the stack is empty to throw the EmptyStackException, 
  // otherwise return the symbol stored in the entry object
  void testException() {
    assertThrows(EmptyStackException.class, () -> opstack.pop(),
        "Test to see if popping an empty stack throws the EmptyStackException");
  }
